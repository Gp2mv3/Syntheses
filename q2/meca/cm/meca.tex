...
Si sur un corps $C$ est appliqué des forces $F^i$ aux points $A^i$ et des purs moments de force $M^j$, on a,% pour n'importe quel point de l'espace $Q$ % Point `fixe' de l'espace ?
\begin{eqnarray*}
	\fo &=& \sum_i \fo^i\\
