...
\begin{solution}
Le principe de Saint-Venant nous dit qu'on peut remplacer la distribution des forces de contact imposées à une interface par une autre distribution statistiquement équivalente (i. e. la somme (intégrale) est la même?) sans influencer de manière significative la solution à distance suffisamment grande de l'interface.
