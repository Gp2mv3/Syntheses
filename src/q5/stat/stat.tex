...
\subsubsection{Intervals de confiance}
...
\begin{align*}
  \mu & \quad n \text{ grand } & Z & = \frac{\bar{x} - \mu}{\sqrt{\frac{\sigma^2}{n}}} \sim \N(0, 1) \text{ ou, si on ne connait pas $\sigma$, }
  \frac{\bar{X} - \mu}{\sqrt{\frac{s^2}{n}}} \sim \N(0, 1)\\
  \mu & \quad n \text{ petit } & T & = \frac{\bar{x} - \mu}{\sqrt{\frac{s^2}{n}}} \sim t_{n-1}\\
