    ...
    \item \textbf{Slot time} : 51.2ms (\textit{minimun frame size = 64bytes})
        \begin{itemize}
            \item[$\to$] Equivaut à deux fois le temps que prend un impulsion électronique
                ...
                Ce slot time permet de détecter les collisions en CSMA/CD
        \end{itemize}
    \item \textbf{Frame format} : 
        \begin{itemize}
            \item dest adresse (48 bits) : multicast, broadcast et unicast
            \item src adresse (48 bits) : Uniquement unicast
            \item type (16), CRC (32)
            \item 46bytes $<$ payload $<$ 1500 bytes
        \end{itemize}
    \item \textbf{Adresses} :
        \begin{itemize}
...
\end{figure}
    ...
    \begin{figure}[!ht]
      \begin{center}
	  \includegraphics[scale=0.3]{impact_of_frame_length_in_ethernet.png}
    ...
    \paragraph{Hub}
      ...
      \begin{figure}[!ht]
	\begin{center}
	    \includegraphics[scale=0.3]{ethernet_hub.png}
    ...
    \paragraph{Le Fast Ethernet} est une technologie LAN qui permet d'aller jusqu'à 100Mbps en utilisant la fibre optique. Le Fast Ethernet subit 2 contraintes :
      ...
      \begin{figure}[!ht]
	\begin{center}
	    \includegraphics[scale=0.3]{ethernet_switches.png}
	...
	\end{center}
      ...
      \begin{figure}[!ht]
	\begin{center}
	    \includegraphics[scale=0.3]{switch_mac_address_table.png}
	...
	\end{tabular}
      ...
      \begin{figure}[!ht]
	  \begin{center}
	      \includegraphics[scale=0.3]{virtual_local_area_networks.png}
      ...
      \begin{figure}[!ht]
	 \begin{center}
	    \includegraphics[scale=0.3]{header_vlan.png}
	...
	\end{tabular}
      ...
      \begin{figure}[!ht]
	 \begin{center}
	    \includegraphics[scale =0.5]{wifi_infrastructure.png}
	 ...
	 \end{center}
      ...
      \begin{figure}[!ht]
	  \begin{center}
	      \includegraphics[scale=0.5]{wifi_access_point.png}
