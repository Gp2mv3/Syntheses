...
\subsubsection{Ethernet}
   ...
   \end{center}
	...
	\end{center}
      ...
      Si on combine le \textit{MAC address learning} et l'algorithme de forwarding, on peut réussir à bien gérer un réseau en arbre. Cependant, un arbre est très mauvais en cas de problèmes avec un lien ou avec un switch et ces algorithmes ne fonctionnent pas avec des boucles ! Nous avons besoin du Spanning Tree Protocol. 
