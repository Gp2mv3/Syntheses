...
\begin{enumerate}
    ...
    \item Pour connaître le \textit{prefix IPv6 subnet}, le router envoi
        régulièrement des ICMPv6 \textbf{Router Advertisement} contenant : 
        \begin{itemize}
        ...
        \begin{itemize}
            \item MTU option : Indique la taille maximun de ce qui peut être
                transmit \textbf{sans} fragmentation sur le subnet
            \item Prefix option : Donne la taille du prefix et sa length, ainsi que la 
