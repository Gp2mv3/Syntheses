...
Le distance vector d'un voisin n'est pas broadcasté (il l'est implicitement
quand l'on envoit son propre distance vector après avoir mis à jour sa forwarding
table)
...
\begin{itemize}
    ...
    \item $LSP.Links[]$ : Contient pour chaque lien les voisins qu'il a ainsi
        que les coûts associés cette paire de lien
\end{itemize}
