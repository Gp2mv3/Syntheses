...
\begin{description}
    ...
    \item[Henry Mintzberg] Structuro-fonctionaliste. Pense que la
        ...
        diagnostic des organisations peut être fait à travers l'analyse
        des rapports entre coordination et pouvoir.
...
l'organisation}, les hommes sont des entités fonctionnelles. Pour les
structuro-fonctionnalistes, le sujet est parfaitement socialisé, au
point de se fondre dans la multiplicité des exigences fonctionnelles que
lui imposent son organisation (on ignore les sentiments d'appartenance
et les sentiments de plaisir ou de souffrance).
...
qui devait se montrer auparavant. \newline

Les 3 principes de la surveillance généralisée selon Foucault :

\begin{enumerate}
    \item \textbf{Le recours à l'emploi du temps}
    \item \textbf{L'articulation \enquote{corps-geste-objet}}
    \item \textbf{L'utilisation exhaustive}
\end{enumerate}
...
Le paradigme structurel a 3 gros défauts :
...
à une \enquote{rationalité limitée} qui ne prétend pas tout maîtriser.
