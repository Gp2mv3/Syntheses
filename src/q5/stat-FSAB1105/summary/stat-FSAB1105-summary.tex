...
appelé une \textit{permutation}. Le nombre de façons
...
\end{align*}
et une observation est considérée comme un \textit{outlier} si elle est
...
Le MSE (\textit{Mean Squared Error}) de $\hat{\theta}$ est défini comme suit:
\begin{align*}
...
Seulement, le \textit{Central Limit Theorem} stipule que pour n'importe quelle distribution
