...
\begin{enumerate}
	...
	\item Soit Success = résoudre l'équation, on peut calculer $P(\overline{B}\cap\overline{A}) = 1 - P(A\cup B) = 1 - 0.85 = \textcolor{blue}{0.15}$, on alors le tableau suivant où les valeurs en rouges sont dans l'énoncé et le reste se déduit facilement.
	\begin{center}
