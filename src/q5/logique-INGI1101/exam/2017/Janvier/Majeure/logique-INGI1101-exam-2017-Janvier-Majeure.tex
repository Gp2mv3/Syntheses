...
Christophe Crochet (graphes, méthode scientifique), Luca Derumier (induction, déduction, abduction), Maxime de Streel (diverses remises en page).
}}
{Peter Van Roy}
...
\begin{enumerate}
	...
	\item Expliquer le méthode scientifique avec les trois formes de raisonnement.
...
\begin{description}
	...
	Par exemple, si par induction nous avons trouvé la règle, "les oiseaux volent",
...
\item Cette sous-question est à la recherche d'une contribution!
\end{enumerate}
\end{solution}
...
\item
Voir pages 100 et suivantes du livre \textit{Networks, Crowds and Markets}.
\end{enumerate}
\end{solution}
