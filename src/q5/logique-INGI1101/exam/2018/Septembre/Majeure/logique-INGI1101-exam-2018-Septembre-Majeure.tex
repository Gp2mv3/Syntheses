...
\textit{Vous obtiendrez la côte maximale entre la première question de l'examen et la cote de l'interro mi-quadrimestre.}

\section{}

\begin{enumerate}
 \item Décrivez les différents types des raisonnements avec un exemple pour chacun
 \item Dessinez un schéma représentant les différents types de raisonnements dans la démarche scientifique
...
\begin{enumerate}
    ...
    \item $\forall x(\textrm{Canard}(X) \Rightarrow \textrm{MaVolaille}(X))$
\end{enumerate}
