...
\underlined{Note:} the \texttt{!marked[s]} condition in the \texttt{DirectedDFS} constructor is useless since the boolean array was created just before and thus all its entries are set to false...
