...
\[ \Delta W_e = \frac{1}{2}\frac{Q^2}{\Delta C}. \]
...
\begin{align*} 
	-\vec{F}_x \cdot \Delta \vec{x} &= \frac{1}{2}\frac{Q^2}{\Delta C} \\
	F_x	&= -\frac{1}{2}\frac{Q^2}{\Delta C}\frac{1}{\Delta x} \\
		&= -\frac{Q^2}{2} \frac{\frac{1}{\Delta C}}{\Delta x} \\
