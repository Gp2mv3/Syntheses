...
\begin{mytheo}[Unicité]
Si le potentiel ou la charge est donnée sur toutes
les surfaces, il n'y a qu'une solution à l'équation
...
% Ou simplement redirigé vers le formulaire correspondant
