...
\begin{enumerate}[label=(\alph*)]
    ...
    \item  Après un temps suffisant pour que le circuit soit en régime, on coupe le générateur. Donner l'évolution de la tension $V_0$ à l'entrée du circuit pendant les 3,6 premières [ns].
\end{enumerate}
