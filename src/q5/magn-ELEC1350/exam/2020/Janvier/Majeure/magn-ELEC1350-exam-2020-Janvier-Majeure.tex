...
Un amplificateur présente une impédance d'entrée de \SI{40-\imagj 30}{\ohm}. On désire l'adapter à une source dont l'impédance série est de \SI{50}{\ohm}.
...
\begin{enumerate}[label=(\alph*)]
    ...
    \item Que peut-on faire pour adapter maintenant à \SI{50+\imagj 20}{\ohm} (au lieu de \SI{50}{\ohm}) avec les mêmes types de lignes ?
\end{enumerate}
