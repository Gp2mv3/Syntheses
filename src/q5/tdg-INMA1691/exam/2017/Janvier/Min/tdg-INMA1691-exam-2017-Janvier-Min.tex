...
{Étudiants MAP de 2017\and Gilles Peiffer}
...
\begin{solution}
	\begin{enumerate}
		\item On utilise un théorème dû à Erdös et Szekeres,
		prouvé en 1935,
		...
		(également due à Erdös et Szekeres).
...
Illustrez cette borne pour l’étoile à $n$ n\oe{}uds
(qui est un arbre avec une racine et $n - 1$ feuilles).
Est-ce une bonne borne, à votre avis?

\begin{solution}

Avec une étoile à $6$ noeuds, $\Delta(G) = 5$,
...
\begin{enumerate}
	...
	à $3 \leq n$ n\oe{}uds et $m$ arêtes
