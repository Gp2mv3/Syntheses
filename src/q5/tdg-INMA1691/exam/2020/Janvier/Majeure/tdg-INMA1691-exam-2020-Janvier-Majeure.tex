...
\section{Question 1}
Les Pokemon sont des créatures tantôt attachantes, tantôt belliqueuses, qui vivent à l'état sauvage mais se laissent volontiers apprivoiser par les dresseurs talentueux.
...
Différents facteurs influencent l'issue du combat: le degré d'évolution de chaque Pokémon, le lien qu'il entretient avec son dresseur, le talent de ce dernier, etc. et aussi le type: ainsi Pikachu (Pokémon de type électrique) a de quoi terroriser Carapuce (type eau), lequel fera boire la tasse à Sabelette (type sol), qui ne fera qu'une bouchée de Pikachu. Il n'y a donc pas un Pokémon qui domine les autres. Étant donné deux espèces de Pokemon distinctes, on peut toujours déterminer laquelle domine l'autre.
