...
\begin{figure}[ht]
	\centering
	\includegraphics[scale=0.35]{img/mos-transistor-structure.png}
...
ont ce qu'on appelle un ``trou´´. Les électrons de atomes
de Silicium peuvent se déplacer de trous en trous et ainsi
créer un courant.

La source et le drain sont quand à eux constitué de Silicium
...
les zones dopées $p$. Dans cette zone de déplétion, il n'y
...
cause de cela, les électrons libres de la zone dopée $n$
sont repoussés par la zone dopée $p$ et aucun courant ne
circule entre le drain et la source. 

Si maintenant une tension positive est appliquée sur la grille,
les électrons libres de la source vont être attirés et,
si cette tension est suffisamment grande, ils
passeront à travers la zone de déplétion pour rejoindre le
drain.
