...
\begin{itemize}
    ...
    \item \textbf{Feature selection}: Explain what feature extraction is. Why is it important to do feature extraction to obtain less but not too many features?
    \item \textbf{Feature selection}: greedy algorithm, explain the advantages and drawbacks of the forward and backward, then speak about the compromises between them. Why does greedy algorithm belong to the non optimal algorithms?
    ...
    \item \textbf{Nonlinear dimensionality reduction}: What is the curse of dimensionality, a special phenomenon due to high dimensionality, distance distortion due to HD and how does it affect machine learning?
