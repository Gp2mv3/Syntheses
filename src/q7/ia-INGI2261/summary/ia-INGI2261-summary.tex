...
An \textbf{AI} is "successful" if it can make a human think that he's speaking with another human.
...
\begin{description}
    ...
    \item[Rationality] : "doing the right thing"... but what \textbf{is} the
        right thing for a computer? Requires a \textit{performance measure}

    \item[Rational  agent]  : For  each  possible  percept sequence, a
