...
\begin{itemize}
    ...
    \item The strain gauge factor for metals can vary over larges values between $-120$ and 200.
...
Give the input-referred noise of this system. (The pressure sensor has a gain $A_{conv}$ and the amplificator, a gain $A_v$
...
We suppose we stay at constant ambient wheather conditions, s.t. the temperature and relative humidity don't have to be taken into account. We use the same glass of height $h_{glass} = 15$ cm.
\[
    R_s = R_0 \left[1-\alpha \left(\frac{h_{liquid}}{h_{glass}}\right)^2\right]
\]
...
\begin{enumerate}
    ...
    \item Knowing the distance $d=h_{glass} - h_{liquid}$, explain how you could introduce it in your project.
