...
\begin{solution}
  \begin{itemize}
    ...
    \item flip flop oscillator: bniary
...
\begin{solution}
  ...
  We use the exposure time as a degrees of freedom. We take multiple images with different exposure times to have a good resolution for each pixel
