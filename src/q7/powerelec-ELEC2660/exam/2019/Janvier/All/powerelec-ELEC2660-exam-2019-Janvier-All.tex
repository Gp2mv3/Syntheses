...
\begin{itemize}
    ...
    \item Une diode avec les caractéristiques suivantes: $V_f = 850$ mV, $R_{th_{j-C}}$ = 0.15 K/W est parcourue par un courant de 50 A pendant 30 \% du temps sur une période. Sachant que l'air ambiant est à 25\degree C et que la température de jonction de la diode ne peut pas dépasser 100\degree C, quelle doit être la résistance thermique du radiateur ?
    ...
    \item Ecrivez l'équation du transfert de puissance complexe entre deux sources de courant alternatives $U_1$ et $U_2$ liées par une inductance $L$.
\end{itemize}
...
Ecrivez la matrice dynamique des états moyennés \textbf{A}, en fonction du rapport cyclique.
