...
\begin{itemize}
    ...
    \item Une diode avec les caractéristiques suivantes : $V_f = 850$ mV, $R_{th_{j-C}}$ = 0.15 K/W est parcourue par un courant de 50 A pendant 30 \% du temps sur une période. Sachant que l'air ambiant est à \SI{25}{\degree} et que la température de jonction de la diode ne peut pas dépasser \SI{100}{\degree}, quelle doit être la résistance thermique du radiateur ?
