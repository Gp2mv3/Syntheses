...
\begin{solution}
	...
	\item Les résistances n'influence pas le fonctionnement du convertisseur mais ne sont que des pertes.
	\item La valeur rms des courant sera approximée par la valeur moyenne
\end{solution}

\subsection{Calculer re rendement en fonction de $V_{in}$ (et des valeurs choisies au point précédent). /5}
