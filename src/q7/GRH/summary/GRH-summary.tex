...
$M=V\times I \times E, \quad$ si une des variables est à 0 alors la motivation est à 0. 
...
La probablilité d'obtenir/d'éviter tel résultat en adoptant un
...
Les individus varient les uns les autres par rapport la valeur qu'il donne à 
