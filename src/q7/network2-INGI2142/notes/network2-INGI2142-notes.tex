...
\begin{tabular}{R{0.48\linewidth} C{0.04\linewidth} L{0.48\linewidth}}
...
\begin{enumerate}
	...
	\item[Accepted] : if accepted by all routers along the path. $\to$ Setut actual reservation and filters ont these router
