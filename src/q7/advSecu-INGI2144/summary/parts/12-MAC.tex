...
\begin{multicols}{2}
	\begin{tikzpicture}
		...
		\node [right = 2.5cm of xor1](xor2) {$\oplus$};
...
Find 2 messages with the same MAC. We have $B_1,B_2$ two arbirtrary
value such that $|B_1|=|B_2|=B$:
\begin{itemize}
	\item $m_3 = m_1 || B_1$
	\item $m_4 = m_2 || B_2$
\end{itemize}
...
\end{align*}
\end{multicols}
If $B_2 = M_1 \oplus M_2 \oplus B1\quad \to\quad Mac(m_4) = Mac(m_3)$
