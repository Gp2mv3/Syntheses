...
\paragraph{Flow table entries}
%TODO slide 81-82 for 08

\paragraph{Messages}
%TODO slide 87 for 08
...
\begin{itemize}
    ...
    \item Normal operation (basic log replication)
    \item Safety and consistency after leader changes
    \item Neutralizing old leaders
    \item Clients interactions (implementing linearizeable semantics)
    \item Configuration changes (add/remove servers)
\end{itemize}
