...
as  a  single-­pass  MapReduce program (\textbf{filter, collect, aggregate, join on shared
element}).
...
processing  are  difficult  to  implement.
        ...
        output is compatible with map input.
...
\begin{itemize}
    \item \textbf{SSSP}: based on dijkstra algorithm idea but parallelized.
        \begin{description}
