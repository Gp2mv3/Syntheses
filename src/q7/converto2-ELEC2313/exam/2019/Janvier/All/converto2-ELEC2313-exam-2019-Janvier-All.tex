...
Some piece of paper are available in order to write the different equations and the schematic blocks.
They ask for the main equations, and knowing the Concordia, Clarke and Park matrix transformations are an asset.
...
\begin{enumerate}
    \item Machine with permanent magnets. What does the position of this magnets involve on the value of $L_d$ and $L_q$ (surface mounted magnets, buried magnets and radial magnets)?
