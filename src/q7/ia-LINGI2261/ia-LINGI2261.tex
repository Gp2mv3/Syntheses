...
\textbf{Learning} improve performance on future tasks after making observations.
...
\begin{enumerate}
    ...
    \item Reinforcement Learning : agent learnfrom a series of reinforcements
...
\begin{description}
    \item[Hypothesis space] : Set of function where h is taken. A classical 
...
\paragraph{Accuracy} To measure accuracy of \textbf{h} we need a \textbf{test set} that 
are distinct of training set.
