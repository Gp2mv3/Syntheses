...
The exam mark is distributed as follows: 50 \% theory, 35 \% exercises and 15 \% laboratory report.
\section{Theory}
\begin{enumerate}
    ...
    \item With regard to the turbulent premixed flames, give the definitions of the Damkohler number and the turbulent Reynolds number, \emph{Da} and \emph{Re}$_T$ respectively. Give the definition and a brief description of the three different flame regimes and represent them on the \emph{Re}$_T$ -- \emph{Da} plane. Identify the flame regime to which the eddy-breakup model is applicable and explain the idea upon which this model is based. (25 \%)
\end{enumerate}

\nosolution

\section{Exercise 1}
Consider the following reaction mechanism for the production of HBr from H$_2$ and Br:
\begin{align*}
    \cee{M + Br_2 &-> Br + Br + M} \\
    \cee{M + Br + Br &-> Br_2 + M} \\
    \cee{Br + H_2 &-> HBr + H} \\
...
\begin{enumerate}
    ...
    \item Write the complete expressions for teh reaction rates of \ce{Br_2} and \ce{Br}, i.e. $\frac{dc_{\mathrm{Br}_2}}{dt}$ and $\frac{dc_{\mathrm{Br}}}{dt}$. (20 \%)
    \item Apply the steady-state approximation to derive an expression for the concentration of the H radical. (20 \%)
\end{enumerate}

\nosolution

\section{Exercise 2}
During the combustion of a piece of wood that contains 25\% humidity, we measured the following concentrations in the combusiton products: $\left[\ce{CO2}\right]'$ = 0.12 and $\left[\ce{O_2}\right]'$ = 0.085. The formulation of wood is \ce{CH_{1.44}O_{0.66}}. Design the Ostwald diagram for wood and identify this particular combustion on it. How does humidity effect the measured concentrations of species in the combustion products? (50 \%)
