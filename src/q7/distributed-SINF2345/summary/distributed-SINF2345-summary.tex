...
\hypertitle{Languages and algorithms for distributed applications}{7}{SINF}{2345}
...
\input{parts/core_problems.tex}

\input{parts/formal_models.tex}

\input{parts/specification_and_implementation.tex}

\input{parts/failure_detector.tex}

\input{parts/leader_election.tex}

\input{parts/reliable_broadcast.tex}

\input{parts/causal_reliable_broadcast.tex}

\input{parts/shared_memory.tex}

\input{parts/consensus.tex}

\input{parts/peer_to_peer.tex}

\input{parts/gossip.tex}

\input{parts/bit_torrent.tex}

\input{parts/raft.tex}
