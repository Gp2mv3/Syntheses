...
\begin{solution}
  \begin{enumerate}
    \item
      ...
      $z - i = r_1e^{i\theta_1}$ et $z + i = r_2e^{i\theta_2}$.
      Une coupure possible est $-\frac{3\pi}{2} \leq \theta_1 < \frac{\pi}{2}$
      $-\frac{\pi}{2} \leq \theta_2 < 3\frac{\pi}{2}$,
      attention, l'angle 0 doit être dans l'interval donc par exemple
      ...
      \begin{align*}
        ...
        & = \frac{i}{2}\log\left(-\frac{z+i}{z-i}\right)\\
        & = \frac{i}{2}\log\left(e^{i\pi}\frac{r_2e^{i\theta_2}}{r_1e^{i\theta_1}}\right)\\
        & = \frac{i}{2}\log(\frac{r_2}{r_1}e^{i(\pi + \theta_2 - \theta_1)}))\\
        & = \frac{i}{2}(i(\pi + \theta_2 - \theta_1) + \log r_2 - \log r_1)\\
        & = \frac{i\log r_2 - i\log r_1 + \theta_1 - \theta_2 - \pi}{2}.
      \end{align*}
      \begin{solfig}{branche}{Coupures et points de branchement}
      	...
      	\draw [red,dashed,thick] (0,-1) -- (0,-2);
      	\draw [fill=red,thick] (0,1)circle(0.1) node[right]{i};
      	\draw [fill=red,thick] (0,-1)circle(0.1)node[right]{-i};
      	\end{tikzpicture}
      \end{solfig}
    ...
    \item
      ...
      \begin{align*}
        ...
        & = \left[\tilde{z} - \frac{\tilde{z}^3}{3} + \frac{\tilde{z}^5}{5} - \frac{\tilde{z}^7}{7} + \cdots\right]_0^z\\
        & = z - \frac{z^3}{3} + \frac{z^5}{5} - \frac{z^7}{7} + \cdots.
      \end{align*}
      Le rayon de convergence est la distance entre $z_0$ et la première singularité.
      Ici $z_0 = 0$ et la première singularité est en $-i$ donc le rayon de convergence est 1.
  \end{enumerate}
\end{solution}
