...
L'énergie interne d'un système est noté $U$ et est une fonction d'état,
elle prend une valeur précise pour chaque état du système.
Pour un gaz parfait, c'est un triplet ($T$,$p$,$V_m$)
...
additionnée à la pression due à la masse égale la pression interne.
Si on retire la masse d'un coup,
le piston va se détendre et fournir un travail d'expansion.
Si on retire petit à petit un morceau de masse telle
...
Les apports de ces deux grandeurs modifient
...
\input{chimie-EPL1302-resume_transformations.tex}
