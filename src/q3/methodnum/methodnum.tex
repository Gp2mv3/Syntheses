...
% TODO : add figure 1.3, page 7 (représentation graphique des
% fonctions de de base de Lagrange).
...
Où
% Quelqu'un pour confirmer que c'est la bonne forme?
$$\phi_j(x) = \frac{\prod_{i \neq j} (x - X_i)(y - Y_i)}
  {\prod_{i \neq j} (X_j - X_i)(Y_j - Y_i)}.$$
	
On a donc bien $\phi_i(X_i, Y_i) = 1$ et $\phi_i(X_j, Y_j) = 0 \forll j\neq i$.  
% TODO : add figure 2.4, page 7 du syllabus de solutions (Représentation
% graphiques des fonctions de bases bilinéaires).
