...
D'ailleurs, en langage noyau, les seules ``lignes''\footnote{Par l'appellation ``ligne'', nous entendons un bloc comme par exemple tout un bloc \lstinline|if ... end| ou encore tout un bloc \lstinline|local ... end| et pas juste un morceau de bloc comme \lstinline|end| ou \lstinline|else|.}
