...
\hypertitle{Physique}{3}{FSAB}{1203}{Benoît Legat}{Benoît Legat}
...
L'onde réfléchie a la même vitesse angulaire $\omega$,
la même fréquence $\nu$, la vitesse même $v$ et la même
longueur d'onde $\lambda$ que l'onde incidente.
...
le segment reliant le milieu des deux fentes au point en question.
...
Sauf bien sûr, les maximas pour lequels $a\sin\theta = n\lambda$.
...
\section{Antennes}
Les antennes sont modèlisées par des segments dans lequel un courant
alternatif circule.
...
dont l'amplitude est inversément proportionnelle à $R$ et l'intensité
est inversément proportionnelles à $R^2$.

Pour analyser l'interférences de plusieurs antennes,
