...
\begin{enumerate}
	...
	\item Une machine frigorifique travaille selon un cylcle de carnot inversé entre une température extérieur de $\SI{30}{\celsius}$ et une température intérieure de $\SI{5}{\celsius}$.Quel est le coefficient de performance de cette machine?
		\begin{align*}
			&3.2
			&12.1&
			&11.1&
...
\begin{figure}[!ht]
	\begin{center}
		...
		\end{tikzpicture}
	\end{center}
	\caption{Varaition de l'énergie libre molaire avec la concentration}
	\label{fig:solution}
\end{figure}
