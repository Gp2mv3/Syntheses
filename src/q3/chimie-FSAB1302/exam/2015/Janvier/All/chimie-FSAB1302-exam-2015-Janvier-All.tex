...
\begin{solution}
  \begin{enumerate}
    ...
    \item
      ...
      Soit $z$ le nombre d'électron échangés. Ici, on a $z = 4$.
      En utilisant la st\oechiométrie de l'équation, on voit que
...
\begin{solution}
 \begin{enumerate}
    ...
    où $Q_{\textnormal{H}}$ est la chaleur échangée à la source chaude. On connaît cette chaleur; elle fait partie des données de l'exercice, à condition de regarder les unités! On peut a donc que $Q_{\textnormal{H}} = \num{2000000} \cdot m \approx \SI{2322}{\joule}$.
