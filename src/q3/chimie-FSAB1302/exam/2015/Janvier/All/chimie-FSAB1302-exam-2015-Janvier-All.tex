...
\hypertitle{Chimie et chimie physique}{3}{FSAB}{1302}{2015}{Janvier}{All}
...
\paragraph{Note}
Cette question semble adaptée de l'exercice 15.89 de la 3\ieme{} édition
française (traduction de la 6\ieme{} édition américaine) du Atkins, Jones et
Laverman.
...
\begin{solution}
  \begin{enumerate}
    ...
    \item
      Les pics qui représentent la formation des intermédiaires \ce{N2O2} et
      \ce{N2O} ne sont pas à la même énergie, mais nous avons aucune
      information pour déterminer lequel sera plus bas. Comme la question
      demande un schéma plausible, il n'y a pas d'unique bonne réponse, à
     ...
     \begin{center}
          \begin{endiagram}[scale=1.7]
               ...
               \ShowEa[
               from = {(N1-3) to (N1-4)},
               label = $E_{\textnormal{a,}2}$
               ]
               \ShowEa[
               from = {(N1-5) to (N1-6)},
               label = $E_{\textnormal{a,}3}$
               ]
               \node[below] at (N1-1) {Réactifs};
               \node[below] at (N1-7) {Produits};
               \ShowGain[
               label=$\Delta H$
               ]
          \end{endiagram}
     ...
     Comme $\Delta H < 0$, la réaction est bien exothermique. On voit aussi
     que le deuxième pic est le plus haut des 3.
...
\begin{enumerate}
  \item Le(s) quel(s) des symboles ci-dessous est (sont) synonyme(s) du potentiel chimique standard d'un composant
    ...
    \begin{enumerate}[label=(\alph*)]
         \item $G_i\std$;
         \item $G_{i,m}\std$;
         \item $(\partial H/\partial n_i)_{S,p,n_{j \neq i}}$;
         \item ${G_m^i}\std$;
         \item $\dif G / \dif n_i$.
    \end{enumerate}
  ...
  \item
    ...
    \begin{enumerate}[label=(\alph*)]
         \item $\SI{11}{\meter\per\second}$;
         \item $\SI{337}{\meter\per\second}$;
         \item $\SI{412}{\meter\per\second}$;
         \item $\SI{300}{\meter\per\second}$;
         \item $\SI{505}{\meter\per\second}$.
    \end{enumerate}
  ...
  \item
    ...
    \begin{enumerate}[label=(\alph*)]
         \item $w_m = \frac{\gamma - 1}{\gamma} p_1v_1 \left(\frac{p_2}{p_1}
         \frac{\gamma - 1}{\gamma}\right)$;
         \item $w_m = \frac{\gamma}{\gamma - 1} p_1v_1 \left(\frac{p_2}{p_1}
         \frac{\gamma - 1}{\gamma}\right)$;
         \item $w_m = c_p T_2 \left(\left(\frac{p_2}{p_1}\right)^{\frac{\gamma
         - n}{\gamma}} - 1\right)$;
         \item $w_m = \frac{p_1v_1}{\gamma - 1}
         \left(\left(\frac{V_1}{V_2}\right)^{\gamma - 1} - 1\right)$;
  ...
  \item
    ...
    \begin{enumerate}[label=(\alph*)]
         \item Chaleur à volume constant;
         \item augmenter le volume à pression constante puis compression isotherme;
         \item détente isotherme puis compression adiabatique;
         \item compression isotherme puis détente adiabatique;
         \item apporter travail à volume constant;
         \item aucune correcte.
    \end{enumerate}
  ...
  \item
    ...
    \begin{enumerate}[label=(\alph*)]
         \item $\SI{1000}{\liter\per\second}$;
         \item $\SI{1}{\kilogram\per\second}$;
         \item $\SI{200}{\liter\per\second}$;
         \item $\SI{2}{\kilogram\per\second}$;
         \item $\SI{16}{\kilogram\per\second}$.
    \end{enumerate}
  ...
  \item
    ...
    \begin{enumerate}[label=(\alph*)]
         \item $p_{\ce{SO2}} < p_{\ce{SO2},\text{éq}}$;
         \item $p_{\ce{SO2}} > p_{\ce{SO2},\text{éq}}$;
         \item $\log(p_{\ce{SO2}}) < \log(p_{\ce{SO2},\text{éq}})$;
         \item $\log(p_{\ce{SO2}}) > \log(p_{\ce{SO2},\text{éq}})$;
         \item $p_{\ce{SO2}} > p_{\ce{O2}}$;
         \item $p_{\ce{SO2}} < p_{\ce{O2}}$.
    \end{enumerate}
\end{enumerate}
...
\begin{solution}
  \begin{enumerate}
    ...
    \item Faux.
    \item
      \[ \phantom{.} \mathrm{COP} = \frac{1}{\frac{T_{\rom{1}}}{T_{\rom{2}}} - 1} = 7.5. \]
    \item
      On a
      \begin{align*}
    ...
    \item $p_{\ce{SO2}} < p_{\ce{SO2},\text{éq}}$, $\log(p_{\ce{SO2}}) <
    \log(p_{\ce{SO2},\text{éq}})$.
  \end{enumerate}
\end{solution}
