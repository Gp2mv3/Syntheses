...
$$ Ag^++e^- => Ag \hspace{50} E^{\circ}_{éq}=0,8V $$
...
$$O_2+4H^++4e^-=>2H_2O \hspace{50} E^{\circ}_{éq}=1,23V$$
La réaction est alors
$$  4Ag+O_2+4H^+=>2H_2O+4Ag^+ $$
...
$$ r=r_2=k_2[HClO][I^-]$$
On a
$$r_1^{->}=k_1[ClO^-][H_2O] \hspace{30} et \hspace{30} r_1^{<-}=k_1^{'}[HClO][OH^-]$$
...
$$ \frac{c_p}{c_v}=\gamma=1,3 \hspace{50} c_p-c_v=R$$
$$ => \hspace{20} c_p=36 \: [J/mol.K] \hspace{50} c_v=27,69\: [J/mol.K]$
...
On connait $V_4$ par l'énoncé et on obtient $p_4$ par la loi de Poisson:
 ...
 $$\Delta S=nc_vln\frac{T_f}{T_i}+nR\frac{V_f}{V_i}$$
 On obtient ainsi $S_3$ et $S_5$.
 On calcule les travaux (les isentropiques sont des transformations avec $Q=0$):
 $$W_{1-2}=\Delta U=nc_vln(\frac{T_2}{T_1})=206,89J$$
 $$W_{2-3}=-p\Delta V=45,6J$$
 $$W_{3-4}=\Delta U=nc_vln(\frac{T_4}{T_3})=408,67J$$
 $$W_{4-5}=-p\Delta V=-588J$$
 $$W_{5-6}=\Delta U=nc_vpln(\frac{T_6}{T_5})=-1668,3J$$
 $$W_{6-1}=0J$$
 Donc,
 $$W_{tot}=-1595J$$
 Finalement,
...
\begin{enumerate}
   ...
   $$ \Delta p=-\frac{\rho}{2} \Delta c^2=-\frac{\rho}{2}\bigg(1-\Big(\frac{R_2}{R_1}\Big)^4\bigg)c^2_2 \Rightarrow c_2^2=\frac{-2\Delta p}{\rho \bigg(1-\Big(\frac{R_2}{R_1}\Big)^4\bigg)}=15,686*10^{-3}$$
   $$ \dot V=\pi R_2^2c_2=10^{-3}\:[m^3/s] $$
