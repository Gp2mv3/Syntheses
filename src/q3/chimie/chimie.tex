...
\[  p_1\nu_1-p_2\nu_2 = -\int_1^2 \dif\left(p\nu\right) =
  -\int_1^2 \nu\dif p - \int_1^2 p\dif \nu \]
Du coup, on peut écrire
\[ w_m = \int_1^2\nu\dif p + \Delta k + g\Delta z + w_f \]
...
$\nu$ est constant et $\int_1^2 \nu\dif p = \nu \Delta p$, on obtient alors
\[ w_m = \nu \Delta p + w_f \]
