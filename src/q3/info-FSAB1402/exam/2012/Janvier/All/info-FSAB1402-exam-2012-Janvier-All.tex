...
Définissez chacun des concepts suivants avec le plus de précision possible. Pour chaque concept donnez un exemple concret (code ou alorithme) pour bien illustrer le concept.
\begin{itemize}
