...
Pour cette question vous devez définir les deux fonctions: \lstinline|Claque4| qui renverse les positions des éléments d'une liste quatre par quatre une fonction et \lstinline|ClaqueK| qui renverse les positions des éléments d'une liste k par k:
\begin{itemize}
