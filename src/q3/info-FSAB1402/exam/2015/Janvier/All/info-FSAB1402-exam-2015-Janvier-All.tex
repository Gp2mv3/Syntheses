...
\begin{enumerate} 
	...
	\item Donnez un pas d'exécution de la machine abstraite pour la création d'une cellule. 
	
	\item Donnez un pas d'exécution de la machine abstraite pour l'affectation d'une cellule. 
 
  \item Donnez un pas d'exécution de la machine abstraite pour la définition d'une procédure.
	
	\item Donnez un pas d'exécution de la machine abstraite pour l'appel d'une procédure.
