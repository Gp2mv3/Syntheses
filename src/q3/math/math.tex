...
Soient deux conditions initiales : $\phi(\Gamma(s)) = f(s)$ et
$\fpart{\phi}{t}(\Gamma(s)) = g(s)$ le long de $\Gamma \equiv (x(s), y(s))$.
...
On remarque qu'on a ici besoin d'une seule condition initiale sur $\phi(\Gamma(s))$
puisque $\fpart{\phi}{t}(x(s), y(s), 0) = \lap \phi(x(s), y(s), 0) = \lap f(x(s), y(s))$.
