...
% TODO : équation de Laplace dans un secteur d'anneau/de cercle
% équation d'onde par séparation de variable, équation de diffusion
...
branches (feuilles \og feuilles \fg).
...
\begin{myexem}\label{ex:branches1}
    ...
    \begin{figure}\label{fig:branches1}
    \centering
...
\begin{mytheo}
  ...
  avec $C \subseteq D$. A partir de la formule intégrale 
