...
<<<<<<< HEAD
Le courant passant à travers le circuit est donc
=======
...
<<<<<<< HEAD
La tension rouge est la tension aux bornes du transformateur. Ensuite la tension verte est la tension au niveau du redresseur (nous avons une chute de tension de 0.7 V par diode). Et finalement, la tension bleue est la tension aux bornes du filtre.
=======
