...
\hypertitle{elec-FSAB1201}{1}{FSAB}{1201}{2016}{Août}
...
\begin{enumerate}[label=\alph*.]
	\item Nous utiliserons la méthode des noeuds aux noeuds de tensions $V_1$ et $V_2$ en supposant les courants sortant du noeud dans chaque branche (ce qui est physiquement impossible mais aide à ne pas faire d'erreurs de signe).
