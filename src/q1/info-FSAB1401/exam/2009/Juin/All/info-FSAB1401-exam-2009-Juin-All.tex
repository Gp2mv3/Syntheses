...
\begin{solution}
	...
	\lstinputlisting[linerange={38-50}]{src/SimpleGame.java}
\end{solution}
...
\lstinputlisting[linerange={92-97}]{src/SimpleGame.java}
...
\lstinputlisting[linerange={37-42}]{src/UndoableGame.java}

\begin{solution}
	% Sans commentaire
	\lstinputlisting[linerange={43-48}]{src/UndoableGame.java}
\end{solution}

% Question 6
\section{}
Dans la classe \code{MoveStack}, complétez le corps de la méthode \code{push}.
\lstinputlisting[linerange={33-39}]{src/MoveStack.java}

\begin{solution}
	% Sans commentaire
	\lstinputlisting[linerange={40-45}]{src/MoveStack.java}
\end{solution}
...
\lstinputlisting[linerange={80-86}]{src/MoveStack.java}
...
\begin{solution}
	...
	\lstinputlisting[linerange={87-101}]{src/MoveStack.java}
\end{solution}
...
\lstinputlisting[linerange={34-46}]{src/GameController.java}
...
\begin{solution}
	...
	\lstinputlisting[linerange={47-77}]{src/GameController.java}
\end{solution}
