/* Dans la suite, on suppose que la liste est bien construite, sans erreurs sur les pointeurs,
 * et que n appartient bien à la liste. */
private void remove(Node n) {
	...
	// safety : on met les références à null, pour faciliter le travail de la JVM
