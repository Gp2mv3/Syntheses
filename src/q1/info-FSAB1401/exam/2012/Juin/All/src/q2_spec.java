/**
 * @pre  filename != null, filename est un nom de fichier qui respecte le format ci-dessous :
 *       La premiere ligne du fichier contient le nombre de chansons dans le fichier. Chaque chanson occupe une ligne du fichier et est de la forme
 *
 *       Titre;Auteur;Duree
 *
