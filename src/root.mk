...
DIRPATH:=/home/martin/Documents/OnedriveEPL/EPL-Drive

PY_SCRIPT:=/home/martin/Documents/Syntheses-PDF-Builder-master/mysmartcp.py
...
cleanaux:
	latexmk -c
	rm -rf *.aux *.fdb_latexmk *.log *.out *.bbl *.run.xml *.toc
