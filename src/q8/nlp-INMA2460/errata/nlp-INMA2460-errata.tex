...
\begin{errata}
  ...
  \erratum[we can bound the sum $\sum_{i=0}^{k} \frac{1}{i+1}$ by $\int_0^k \frac{1}{i+1} = \ln(k+1)$ and
the sum $\sum_{i=0}^{k} \frac{1}{\sqrt{i+1}}$ by $\int_0^k \frac{1}{\sqrt{i+1}} = 2(\sqrt(k+1)-1)$.]{143}{-8}{$\frac{R^2+r\ln(k+1)}{2r\sqrt{k+1}}$}{$\frac{R^2+r^2\ln(k+1)}{4r\sqrt{k+1}}$}
\end{errata}
