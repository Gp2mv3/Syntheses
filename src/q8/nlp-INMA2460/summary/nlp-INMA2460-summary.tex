...
we can
upper bound the sum $\sum_{i=0}^{k} \frac{1}{i+1}$ by $\int_0^{k+2} \frac{1}{x+1} \dif x = \ln(k+3)$ and
lower bound the sum $\sum_{i=0}^{k} \frac{1}{\sqrt{i+1}}$ by $\int_0^{k+1} \frac{1}{\sqrt{x+1}} \dif x = 2(\sqrt{k+2}-1)$.
Therefore we have (using $k+1$ instead of $k+3$ and $k+2$ to have a similar bound than the \cite{nesterov2004introductory})
...
Again, we can
upper bound the sum $\sum_{i=0}^{k} \frac{1}{i+1}$ by $\ln(k+3)$ and
lower bound the sum $\sum_{i=0}^k \frac{1}{(i+1)^2}$ by $\int_0^{k+1} \frac{1}{(x+1)^2} \dif x = 1 - \frac{1}{k+2}$.
Therefore we have (using $k+1$ instead of $k+3$ and $k+2$ to have a similar bound than the \cite{nesterov2004introductory})
