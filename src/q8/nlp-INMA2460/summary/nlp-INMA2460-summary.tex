...
Therefore we have (using $k+1$ instead of $k+2$ to have a similar bound than the \cite{nesterov2004introductory})
...
Again, we can
upper bound the sum $\sum_{i=0}^{k} \frac{1}{i+1}$ by $1+\ln(k+1)$ and
