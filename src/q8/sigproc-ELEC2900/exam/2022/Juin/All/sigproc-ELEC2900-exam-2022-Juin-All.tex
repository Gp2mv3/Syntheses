...
\hypertitle{Signal processing}{8}{ELEC}{2900}{2022}{June}{All}
{Julien Giunta}
{Laurent Jacques, François Rottenberg and Luc Vandendorpe}

\section{}

We have a signal at $\SI{5}{\mega\text{ samples}\per\second}$ and we would like to know the same signal at a rate of $\SI{6}{\mega\text{ samples}\per\second}$
