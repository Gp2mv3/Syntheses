...
\begin{enumerate}
    \item Give the temporal expressions of the polyphase components of type I et II of a signal $h[n]$, written $h_k[n]$ and $\Tilde{h}_k[n]$, respectively. Give the link which exists between them.
