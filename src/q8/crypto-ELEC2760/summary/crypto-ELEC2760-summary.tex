...
\begin{align*}
  ...
  & = \frac{1}{2^n}.
\end{align*}
We have $(2^n-1)!$ permutations $p$ such that $p(x) = y$ because the output of $p(x)$ is fixed,
the output of the $p(x+1)$ can be chosen in all the $n$-bits strings but $y$ so $2^n-1$ choice,
