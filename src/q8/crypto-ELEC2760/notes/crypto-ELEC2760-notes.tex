...
For an encryption, there are 16 S-boxes per round and 11 rounds so 176 encryptions in total.
Let $N_e$ be the number of encryptions,
with the RAM it takes $1280 + 2 \cdot 176 \cdot N_e$ and with the ROM it takes $3 \cdot 176 \cdot N_e$ so it is interesting to do the transfer to the RAM is there is 8 encryptions in a row or more.
