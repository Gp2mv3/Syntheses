...
\begin{itemize}
    ...
    \item A set of \textbf{resources} $(R = \{r_1,\cdots, r_m\})$
        ...
        \begin{itemize}
            \item Unary resources : can be used by only one activity
            \item Cumulative resources : can be used by activities up to a capacity
            \item Reservoir resources : can be consumed or produced by activities
