...
\begin{figure}[!ht]
    \begin{minipage}{\linewidth}
        \begin{minipage}{0.45\linewidth}
            \centering
            \includegraphics[width=\linewidth]{fault_tree_analysis.png}
        \end{minipage}
        \begin{minipage}{0.45\linewidth}
            Root = failure
...
\begin{figure}[!ht]
    \begin{minipage}{\linewidth}
        \begin{minipage}{0.45\linewidth}
            \centering
            \includegraphics[width=\linewidth]{cut_set_computation.png}
        \end{minipage}
        \begin{minipage}{0.45\linewidth}
...
Example of measurement method: weighted comparison.

\begin{figure}[!ht]
    \centering
    \includegraphics[width=\linewidth]{trade_off_analysis.png}
\end{figure}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=\linewidth]{dromey_quality_model.png}
\end{figure}
