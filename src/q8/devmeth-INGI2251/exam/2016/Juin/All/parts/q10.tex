...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.8\linewidth]{coupling.png}
\end{figure}

Types of coupling:
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.6\linewidth]{types_of_coupling.png}
\end{figure}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.6\linewidth]{types_of_cohesion.png}
\end{figure}
...
\begin{figure}[!ht]
    \begin{minipage}{\linewidth}
        \begin{minipage}{0.45\linewidth}
            \includegraphics[width=0.8\linewidth]{use_graph_1.png}
        \end{minipage}
        \begin{minipage}{0.45\linewidth}
