...
Je me suis basé sur le livre de référence et les différents slides mais vu le peu de détails sur la matière, cette synthèse part un peu dans tous les sens (la partie 8 particulièrement)!
...
\begin{center}
    \includegraphics[scale=1]{pictures/introduction/photo2.PNG}
\end{center} 
...
\begin{figure}[h!]
    \centering
    \includegraphics[scale=1]{pictures/introduction/photo3.PNG}
\end{figure} 
...
\subsection{Mineralogie}
    ...
    \begin{center}
    \includegraphics[scale=1]{pictures/part2/photo1.PNG}
\end{center} 
...
\begin{center}
    \includegraphics[scale=1]{pictures/part2/photo3.PNG}
\end{center} 
...
\begin{center}
    \includegraphics[scale=1]{pictures/part2/photo4.PNG}
\end{center} 
...
\begin{center}
    \includegraphics[scale=0.8]{pictures/part4/photo1.PNG}
\end{center} 
...
\begin{center}
    \includegraphics[scale=0.8]{pictures/part4/photo2.PNG}
\end{center} 
...
\begin{center}
    \includegraphics[scale=1]{pictures/part4/photo13.PNG}
\end{center} 

\subsubsection{Punch through}

\begin{center}
    \includegraphics[scale=1]{pictures/part4/photo14.PNG}
\end{center} 
...
\begin{center}
    \includegraphics[scale=0.8]{pictures/part6/photo7.PNG}
\end{center} 
