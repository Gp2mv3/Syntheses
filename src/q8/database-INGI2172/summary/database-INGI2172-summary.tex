...
\begin{itemize}
	\item Variable :  qui ne permettent pC'est une table mais le prof aime pas le mot table donc on dit variable pour la représentation, à un temps t, de la fonction
    \item Relation : Fonction quoi lie les attributs entre eux
    \item Attribut : Un champ de la variable
    \item Cardinalité :  nombre de n-tuple
    \item Orthogonalité : je sais pas
