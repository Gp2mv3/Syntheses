...
\begin{itemize}
    \item \textbf{Atomic}: toute la transaction se fait en une fois: si ça plante,
        ça revient à l'état d'avant
    \item \textbf{Concistant}: toutes les contraintes sont vérifiées
    \item \textbf{Isolated}: il vaut pouvoir gérer les concurrences
    \item \textbf{Durability}: une fois que la transaction est fini, l'état est
        changé et il est durable...
