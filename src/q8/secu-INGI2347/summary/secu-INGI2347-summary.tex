...
\begin{enumerate}
    \item Eviter les bug dans le code C en utilisant des
        ...
        \begin{itemize}
            \item[Pour:] Evite la première source de problème
            \item[Contre:] Toujours difficile d'être sur que le
    ...
    \item Utiliser des outils pour trouver des bugs.
        ...
        \begin{itemize}
            \item[Pour:] Toute analyse du programme est utile pour
                diminuer les bugs du programmes
            \item[Contre:] Difficile de prouver l'absence total de bug
        \end{itemize}

    \item Utiliser des languages \textit{memory-safe} comme JS, C\#, Python,\ldots

        \begin{itemize}
            \item[Pour:] Prévient toute corruption de la mémoire en n'exposant pas
