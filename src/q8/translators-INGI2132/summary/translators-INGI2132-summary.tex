...
L'analyse sémantique requiert 2 traversés de l'AST car des classes et
méthodes peuvent être déclarées après une référence. La première
analyse est un une \texttt{preAnalyze()} qui va:
