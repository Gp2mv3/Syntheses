...
écrit par le programmeur du compilateur ou bien générée
...
$\to$ C'est pourquoi il est très utile de décrire le scanner
comme un \textbf{state transition diagram}.
