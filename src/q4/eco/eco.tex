...
%TODO Prix et généralisation à n compétiteurs + elasticité
...
% J'avoue ne pas avoir été très attentif à ce cours ci donc peut etre ajouter 2/3 trucs.
...
%Une grande firme controle le marché comme en monopole mais de petites firmes
%sont aussi présentes. Seule la grande influence réellement le marché, elle
%va donc maximiser son profit.
%La F.D. va placer sa courbe de demande (inférieure à la demande totale),
%les autres firmes couvrent la demande excédant celle couverte par la F.D.

%TODO je ne pense pas avoir encore bien étudié ça donc surement pas juste...
