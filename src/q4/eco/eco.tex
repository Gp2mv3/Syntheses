...
\begin{description}
  \item[Bentham]
	...
	situés sur une droite de coefficient $-1$.
    Une diminution de l'utilité d'un ne
	peut qu'augmenter l'utilité de l'autre. (Concept de vases communicants)
  \item[Rawls]
