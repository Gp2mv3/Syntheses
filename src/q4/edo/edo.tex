...
On remarque le l'exponentielle d'opérateurs se simplifie grandement
...
il faudra imposer une condition sur $f$.
Il va falloir que
...
il suffit que la seule solution du problème homogène (donc avec $f = 0$)
