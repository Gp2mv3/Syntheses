...
\paragraph{Bit-shift à gauche} $n$ bits sont déplacés vers la gauche en ajoutant des 0 à droite.
En C : \texttt{a=n>>B}.
\paragraph{Bit-shift à droite} $n$ bits sont déplacés vers la droite en ajoutant des 0 à gauche.
En C : \texttt{a=n<<B}.
