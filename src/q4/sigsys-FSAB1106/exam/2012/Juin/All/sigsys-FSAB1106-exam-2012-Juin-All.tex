...
$$i_C(t) = C \cfrac{\diff v_C(t)}{\diff t},$$
$$v_L(t) = L \cfrac{\diff i_L(t)}{\diff t},$$
...
$$LC \frac{\diff^{2}y(t)}{\diff t^{2}}+RC\frac{\diff y(t)}{\diff t}+ y =LC\frac{\diff^2x(t)}{\diff t^2}.$$
\begin{itemize}
...
\begin{solution}
	\begin{itemize}
		...
		$$y(t) = \delta(t)  + (1000\e^{-1000t}- 4000\e^{-2000t})u(t)$$
