...
où la $\roc$ contient $\roc \cap \set{ s \in \C \suchthat \Re\{s\} > 0}$.\\
...
\begin{description}
  ...
  \item[Signal de support fini à gauche\footnotemark]\footnotetext{Un signal de
	...
	cela se traduit par \emph{right-sided} (resp. \textit{left-sided}) en anglais.}
		$\roc = \set{ s \in \C \suchthat \Re\{s\} > k}$ ;
	\item[Signal de support fini à droite]
		$\roc = \set{ s \in \C \suchthat \Re\{s\} < k}$ ;
	\item[Signal de support infini]
		$\roc = \set{ s \in \C \suchthat k_1 < \Re\{s\} < k_2}$.
\end{description}
...
\begin{description}
  ...
  \item[Signal de support fini à gauche]
		$\roc = \set{ s \in \C \suchthat \abs{z} > r}$ ;
	\item[Signal de support fini à droite]
		$\roc = \set{ s \in \C \suchthat \abs{z} < r}$ ;
	\item[Signal de support infini]
		$\roc = \set{ z \in \C \suchthat r_1 < \abs{z} < r_2}$.
\end{description}
