...
\begin{table}
  ...
  \begin{tabular}{|l|l|}
    ...
    Contante $K$ & $20\log|K|$\\
    \hline
    Zéro nul & $20\si{\decibel\per decade}$ passant par $0\si{\decibel}$ pour
    $\omega=1$\\
    \hline
    Pôle nul & $-20\si{\decibel\per decade}$ passant par $0\si{\decibel}$ pour
    $\omega=1$\\
    \hline
    Zéro réel & $20\si{\decibel\per decade}$ à partir de $\omega = \omega_0$\\
    \hline
    Pôle réel & $-20\si{\decibel\per decade}$ à partir de $\omega = \omega_0$\\
    \hline
    Zéros conjugués &
    $40\si{\decibel\per decade}$ à partir de $\omega = \omega_0$.\\
  ...
  ``À partir de'' signifie que c'est $0\si{\decibel}$ avant et puis
  que ça part de $0\si{\decibel}$.}
  \label{tab:bode}
\end{table}
...
\begin{myexem}
  ...
  \begin{itemize}
    ...
    \item un zéro nul ce qui fait une droit qui passe par $(0,1)$
      avec une pente de $20\si{\decibel\per decade}$;
    \item un pôle réel à $s = -10$ ce qui fait
      $-20\si{\decibel\per decade}$ à partir de $\omega = 10$;
    \item un double pôle réel à $s = -1$ ce qui fait
      $-40\si{\decibel\per decade}$ à partir de $\omega = 1$.
  \end{itemize}
