...
\hypertitle{fr}{Circuits \& Mesures}
{4}{ELEC}{1370}
...
\includegraphics[width=\linewidth]{diviseurtension}
\end{minipage}
\qquad \qquad \qquad
\begin{minipage}{.5\linewidth}
\includegraphics[width=\linewidth]{diviseurcourant}
\end{minipage}
...
\begin{figure}[H]
\centering
\includegraphics[width=.7\linewidth]{triangleetoile}
...
\todo[color=yellow]{Un schéma plus général que direct un montage?}
...
\begin{figure}[h]
\centering
\includegraphics[width=.3\linewidth]{aopIO}
...
\begin{figure}[h]
	\centering
    \includegraphics[scale=0.65]{thev}
...
\includegraphics[width=\linewidth]{RC}
\end{minipage}
\hfill
\begin{minipage}{.35\linewidth}
...
\begin{figure}[h]
	\centering
    \includegraphics[scale=1.35]{quadriSens}
...
\begin{figure}[h]
	\centering
    \includegraphics[scale=0.45, trim =0 3cm 0 2cm, clip]{quadri}
...
\begin{figure}[h]
	\centering
    \includegraphics[scale=1.25]{bobine}
...
\begin{figure}[h]
	\centering
    \includegraphics[scale=0.75]{transfo}
...
\begin{figure}[h]
	\centering
    \includegraphics[scale=0.85]{puissanceComplexe}
...
\begin{figure}[h]
	\centering
    \includegraphics[scale=0.65]{source3}
