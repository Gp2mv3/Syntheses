...
\begin{itemize}
\item Mécanique: Étude de la relation entre les mouvements (et \og non-mouvements \fg{}) de systèmes matériels soumis à des forces et des couples.
\item Cinématique: Étude du mouvement \og pour lui-même\fg{} en vue de:
\begin{enumerate}
\item l’analyse de mécanismes (ex: cardan) $\rightarrow$ calculer les déplacements, vitesses et accélérations de tout point/corps en fonction du temps;
...
\item Statique: Étude des systèmes en équilibre.
\item Pseudo-statique : Etude des systèmes dont la \og dynamique\fg{} peut être négligée (mouvements lents et/ou masses + inerties faibles) $\rightarrow$ recours aux équations de la statique.
\item Dynamique :
\begin{enumerate}
