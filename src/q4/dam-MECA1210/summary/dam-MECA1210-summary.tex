...
\begin{itemize}
\item Mécanique: Etude de la relation entre les mouvements (et "non-mouvements") de systèmes matériels soumis à des forces et des couples.
...
\item la synthèse de mécanismes $\rightarrow$ trouver le "meilleur" mécanisme capable de réaliser une tâche donnée.
\end{enumerate}
