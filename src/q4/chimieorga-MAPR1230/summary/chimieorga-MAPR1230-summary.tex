...
On sait que un alcène est un nucléophile, les électrons de la liaison $\chempi$ attaque l'électrophile du réactif A-B ( $\delta^+$ ).
L'attaque entraine la rupture de la liaison $\chemsigma$ du réactif ainsi que la formation d'une nouvelle liaison $\chemsigma$ entre l'un des carbone du double lien et de l'atome A.
...
Les orbitales sp sont impliquée dans les liaisons $\chemsigma$  tandis que les orbitales p permettent la formation des liaisons $\chempi$.
Une liaisons triple est constitué d'une seule liaison $\chemsigma$ et de deux liaisons $\chempi$.
...
\begin{description}
  \item[Addition des halogénures d'hydrogène et d'halogénation]
    ...
    Par contre, ma réactivité est double avec les alcynes puisqu'il ont deux liaisons $\chempi$.
...
Lorsqu'un composé halogéné, avec un atome d'hydrogène attaché à l'atome de carbone adjacent ( carbone $\chembeta$ ) au carbone portant l'halogène ( carbone $\chemalpha$), réagit avec un nucléophile, deux réaction concurrentes sont possible : la substitution et l'élimination.
...
L'halogène du  carbone $\chemalpha$ et l'atome d'hydrogène ducarbone $\chembeta$ sont éliminés, et nouvelle liaison ( un lien $\chempi$) est formée entre les deux carbone .
...
Le nucléophile, qui tient lieu de base, arrache l'atome l'atome d'hydrogène porté par un carbone $\chembeta$.
