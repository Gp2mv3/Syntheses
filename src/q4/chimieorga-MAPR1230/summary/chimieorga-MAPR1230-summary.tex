...
\begin{tabular}{cc}
  \hline
  \multirow{11}{*}{Substituants activants et orienteurs en ortho, para} & \\
  &  amino \\
  & \\
  &  hydroxy, alkoxy \\
  & \\
  ...
  \multirow{11}{*}{Substituants déactivants et orienteurs en ortho, para} & \\
  &  acyl, carboxyl \\
  & \\
...
\end{tabular}
\end{center}
% TODO : translate functional group names
...
Pour les petites molécules d'alcool, celles-ci sont miscibles dans l'eau grâce au ponts hydrogène.
...
\begin{description}
  ...
  \item[L'addition d'alcool].
    ...
    Le mécanisme se fait en trois étapes. Tout d'abord, le catalyseur acide protone l'atome d'oxygène.
...
Tout d'abord, la base arrache un hydrogène $\chemalpha$ pour produire un ion énolate.
Ensuite, cet anion attaque l'atome de carbone carbonylique d'une autre molécule d'éthanal, ce qui conduit à la formation d'une nouvelle liaison \ch{C-C} et à l'apparition d'un nouveau carbone stéréogénique.
Enfin, l'ion aldolate accepte un proton du solvant et régénère ainsi l'ion hydroxyde nécessaire pour la 1\ieme{} étape.
...
Dans ces molécules, les acides aminés sont reliés les uns aux autres par des liaisons amides, appelées liaisons peptidiques, établies entre le groupe carboxyle d'un acide aminé et le groupe $\chemalpha$-aminés d'un autre acide aminé.
...
Dans cette structure,  il y a les forme en hélice $\chemalpha$ et les feuillets $\chembeta$.
