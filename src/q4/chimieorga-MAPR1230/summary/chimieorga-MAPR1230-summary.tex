...
\begin{itemize}
  ...
  \item contient 4n + 2 électrons délocalisables ( électron $\chempi$ ou des doublets d'électron libre) et si n n'est pas entier, le composé n'est pas aromatique.
  \item est plan
\end{itemize}
...
L'un d'eux est la structure de Kekulé, indiquant clairement la présence des six électrons $\chempi$, et l'autre, un hexagone avec un cercle à l'intérieur, symbolisant des électrons du nuages $\chempi$.
...
Comme chez les composé halogénés, il existe une compétition entre les mécanisme $E2$ et \SN2 chez les alcools primaire et secondaire.
Les alcools tertiaires, quand à eux, ne sont pas de bons nucléophile pour réaliser une \SN1 en raison de leur fort encombrement stérique.
...
Grâce à son aptitudes accrue à former des ponts hydrogène, l'éthylène de glycol est miscible dans l'eau et possèdent un point d'ébullition exceptionnellement élevé pour sa masse molaire.
...
Par conséquent les phénols ne peuvent pas  subir une substitution de leur groupe hydroxyle selon les mécanisme \SN1 t \SN2.
...
La réaction se réalisant en présence de chaleur, il y a une compétition entre la formation d'un alcène ($E2$) et de la formation de l'éther ( \SN2).
...
Au cours de la deuxième étape, une substitution nucléophile de type \SN2 a lieu sur un des carbones d l'époxydes, l'eau étant un nucléophile.
...
Un anion énolate est formé par élimination d'un atome H en $\chemalpha$ d'un aldéhyde ou d'une cétone.
L'atome d'hydrogène $\chemalpha$ d'un composé carbonylé est plus labile qu'un atome d'hydrogène d'un groupe alkyle.
Le fait de placer un groupe carboyle à proximité d'un atome d'hydrogène d'un groupe R entraine une augmentation spectaculaire de l'acidité du composé  d'un facteur $10^{30}$! Ils sont donc  des acides presque aussi forts que les alcools car :
\begin{itemize}
...
Le chauffage des aldols en milieu acide conduit à la perte d'une molécule d'eau, et la double liaison est crée préférentiellement entre les atomes de carbone $\chemalpha$ et $\beta $ puisqu'il y a formation d'un système conjugué.
