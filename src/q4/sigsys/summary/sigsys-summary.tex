...
tiré de \cite[pp.~341]{haykin2003}. Imaginons que l'on applique
...
dans la section \sectionref{fourier-transform-properties},
...
temps $t_0$ entraîne un retard (ou une avance) identique
de la sortie. Mathématiquement,
...
% TODO : avantage(s) d'avoir A diagonale?
