...
\end{solution}
%7200 tours/minutes * 63 secteurs/pistes * 512 bytes/secteur * 1 piste / 60 secondes/minute = 3870720 bytes/seconde
%Comment atteint-il les 300MB/s ? La mémoire cache. Seulement, quand on dépasse les 32MB du cache, ça ne marche plus.
...
\end{enumerate}
\end{solution}
%110 - 0110111010 => 000 - 0110111010 valide
%011 - 0000110010 => 011 - 0000110010 valide
%000 - 0010010001 => 100 - 0010010001 valide
%100 - 0010001001 : la page est marquée comme invalide, et donc l'adresse n'est pas en mémoire RAM.
%000 - 0000000000 => 100 - 0000000000 valide

\question{3}
Un processus est chargé en mémoire.
L’output de /proc/pid/maps est le suivant :
\begin{lstlisting}
...
%La page est de 4KiB, donc 12 bits, donc se représente avec 3 chiffres hexadécimaux (c'est pour ça qu'il y a autant de zéros).
%8 chiffres hexadécimaux = 32 bits = 4GiB virtuel et 4GiB physique
%
%-----------------------------------------------------------------------
%Indice | Val. | Adresse | RWXP | Notes
%-----------------------------------------------------------------------
%08047 |  T   | 00000   | r-xp | Début su segment code
%08048 |  T   | 00001   | r-xp |
%08049 |  T   | 00002   | r-xp |
%0804a |  T   | 00003   | r-xp |
%..... .  ..  . .....   . .... .
...
%080f2 |  T   | 000ab   | r-xp |
%080f3 |  T   | 000ac   | r-xp |
%080f4 |  T   | 000ad   | r-xp | Fin du segment code
%080f5 |  T   | 000ae   | rw-p | Début du segment data
%080f6 |  T   | 000af   | rw-p |
%080f7 |  T   | 000b0   | rw-p |
%080f8 |  T   | 000b1   | rw-p |
%080f9 |  T   | 000b2   | rw-p | Fin du segment data
%080fa |  F   | ------  | ---- | Invalide
%..... .  ..  . .....   . .... .
%09046 |  F   | ------  | ---- | Invalide
%09047 |  T   | 09047   | rw-p | Début du heap
%09048 |  T   | 09048   | rw-p |
%..... .  ..  . .....   . .... .
%09106 |  T   | 09106   | rw-p | Fin du heap
%09107 |  F   | ------  | ---- | Invalide
%..... .  ..  . .....   . .... .
%bffa9 |  F   | ------  | ---- | Invalide
%bffaa |  T   | bffe9   | rw-p | Début (enfin, fin) du stack
%..... .  ..  . .....   . .... .
%bffbe |  T   | bfffd   | rw-p | Fin (enfin, début) du stack
%bffbf |  F   | -----   | ---- | Invalide
%..... .  ..  . .....   . .... .
%fffff |  F   | ------  | ---- | Fin de l'espace d'adressage ; invalide
%-----------------------------------------------------------------------
