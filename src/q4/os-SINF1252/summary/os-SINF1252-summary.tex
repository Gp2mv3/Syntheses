...
\begin{table}[!ht]
  \begin{center}
    \begin{tabular}{|c|c||c|c|c|c|c}
      ...
      \hline
      \multicolumn{2}{|l|}{\textbf{Opération\footnotemark}} & \texttt{$\sim$a} & \lstinline|a&b| & \lstinline$a|b$ & \lstinline|a^b| \\
      \hline
...
soient alignées sur des blocs de 16 bits soit 4 bytes.
