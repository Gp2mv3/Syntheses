...
Cette perturbation garder un $B_k$ qui a du sens, on impose donc
...
\end{itemize}
De plus, on ne peut garantir que
...
telle que $\forall k$
\[ \|\grad^2 f(x_k)\|\cdot\|\grad^2 f(x_k)\| \leq M. \]
