...
\section{}
Soit $X(t)$ un signal aléatoire à bande étroite B, faiblement stationnaire. On note sa densité spectrale de puissance par $\gamma_{X}(w)$ et ses composantes de Rice, extraites autour de la porteuse à pulsation $w_{0}$, $X_{1}(t)$ et $X_{2}(t)$.
\begin{enumerate}
