...
Avec la radio les sons gauche et droit sont envoyés ensemble sous un
...
un signal numérique. On va pour cela \textbf{échantilonner} le signal
...
\end{itemize}
Il faut faire très attention lors de l'échantillonage des erreurs
