...
On représente habituellement les lignes comme une résistance $R'$, une conductance $G'$, une inductance $L'$ et une capacité $C'$. Le morceau de ligne suivant se répète tout au long de la ligne:
\begin{figure}[H]
\centering
...
\begin{description}
  \item[L'atténuation d'un signal] d'une ligne peut être calculé comme
      ...
      \textbf{décibels} ($dB$). Il s'agit d'un rapport de puissance. Si on l'exprime en tension $20 log(V_1/V_2)$.
\end{description}
