...
ressources, etc… en produit ou service afin d’atteindre des objectifs.
...
Zoné 1 : système fermé, approche rationnelle.
...
Zone 2 : système fermé, approche sociale
...
Zoné 3 : Système ouvert, approche rationnelle.
...
Zoné 4 : système fermé, approche sociale
...
L’observation naturelle : On observe des indiivuds ou des groupes
...
Le sondage : on utilise un questionnaire standardisé afin de mesurer
certains variables utiles à la prise de décision.
L’étude de terrain : elle permet l’étude de corrélation entre plusieurs
...
L’expérience de terrain : se rapproche fortement de l’étude de terrain à
la différence qu’ici on va modifier de façon intentionnelle
l’environnement ou une variable. 
L’expérience en laboratoire : on isole les variables que l’on veut
...
Le rôle de strategic partner : On allie le travail des HR avec le
travail stratégique. 
Le rôle d’expert administratif : Ce rôle représente les fonctions
traditionnelles des HR. Il concerne également la construction des
structures RH. 
Le rôle d’agent de change : C’est un rôle très important car il va
permettre à l’entreprise de trouver les moyens de rester compétitive. 
Le rôle d’employee champion : Cette fonction s’occupe des problèmes au
...
valeurs (logos, noms d’objets, règlements, etc…).

\begin{figure}[H]
    \centering
    \includegraphics{modele_de_schein.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics{modele_de_quinn.png}
\end{figure}
...
Section 2 : Qu’est-ce que le pouvoir ?  
Définition : Le fait qu’A puisse obtenir de B une action qu’il n’aurait
pas faite tout seul. 

Les différents types de pouvoir : 
Pouvoir statutaire : le pouvoir est attaché et lié à une fonction. La
...
l’exercer. 
Pouvoir organisationnel : C’est le pouvoir lié à l’incertitude. Si l’on
...
Le pouvoir personnel : Ce pouvoir vient de l’admiration des autres et de
...
avoir un versant négatif comme la création d’un complexe d’Œdipe. 
...
Hiérarchique
De travail (les individus travaillent tous sur la même tâche)
D’intérêt (on travaille pour un objectif profitable à tous ceux du
groupe)
D’affinité (les gens partagent des point communs)
Pourquoi construire un groupe : Besoin de sécurité ; statut ; estime de
soi ; appartenance ; pouvoir ; réalisation d’objectif.
Section 2 : Les étapes de la dynamique de groupe.
...
Les rôles : comportement prévisible d’une personne qui occupe une
position donnée dans un contexte social donné.
L’identité de rôle : attitudes et comportement attendus d’un rôle.
Perception de rôle : idée qu’un individu se fait de la façon dont il est
censé se comporter dans une situation donnée. 
Les attentes de rôle : idée que les autres se font quant au comportement
qu’une personne doit adopter dans une situation donnée. 
Le contrat psychologique : accord tacite qui définit ce qu’un employeur
attend de ses employés et vice versa. 
Conflit de rôle : situation dans laquelle les attentes correspondant à
des rôles différents divergent. 
Les normes : attitude à avoir lorsque l’on est dans un groupe. On peut
...
etc\ldots)
La conformité : action d’ajuster son comportement de façon à s’aligner
sur les normes du groupe.
Groupe de référence : groupes les plus importants auxquels les individus
appartiennent ou souhaitent appartenir et pour lesquels ils acceptent de
se conformer aux normes. 
Comportements professionnels déviants : actes antisociaux de certains
...
Statut : place ou rang occupé au sein d’un groupe et conférant un
...
son équipe. 
La taille d’un groupe : La taille joue un rôle non négligeable sur
...
La paresse sociale : tendance à fournir moins d’efforts et à diminuer
son rendement au sein d’un groupe en situation de travail collectif. 


Cohésion : force qui unit les membres d’un groupe et les incite à y
...
Les atouts de la décision collective : plus d’informations et d’idées
pour prendre la décision ; la décision est plus pertinente et plus vite
accepté. 
Les faiblesses : ambiguïté quant à la responsabilité ; collaboration
...
La pensée de groupe : tendance des membres à dissimuler une opinion
divergente ou minoritaire voire à perdre tout sens critique sous la
pression des normes de conformité. 
Déplacement de groupe : caractérise la valorisation de prise de risque
...
Les quatre besoins humains : 
Le besoin d’acquérir et de conserver. 
Le besoin d’entrer en relation.
Le besoin d’apprendre.
Le besoin de défendre. 
