...
\begin{enumerate}
	...
	\item Si $A \in NP$ et $A \leq_{q} SAT$ alors A est NP-Complet.
\end{enumerate}

\section{Énoncer précisément le théorème de Rice, l'expliquer et en donner les conséquences}
\textit{4 pts}
\section[Réduction polynomiale et SAT appartenant à P]{Définir la réduction polynomiale et prouver que si $SAT \subseteq P$ alors $P=NP$}
\textit{4 pts}
\end{document}
