...
\begin{myprop}
	$A$ récursivement énumérable et ($\N \setminus A$) récursivement énumérable
...
\begin{myprop}
	...
	On sait que le programme se termine, donc il trouve la réponse. Or,
	une combinaison particulière de la mémoire est cette réponse.
	Le programme ne peut pas générer plus que le nombre de combinaisons
	possibles de la mémoire, sinon il passerait la réponse.
\end{myprop}
