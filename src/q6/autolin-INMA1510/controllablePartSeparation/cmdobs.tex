...
%%%%%%%%%%%%%%%%%%%%%%%% CHANGE HERE %%%%%%%%%%%%%%%%%%%% {
\newcommand\course{LINMA1510 : Linear control} % - Numerical analysis: Approximation, Interpolation, Integration}
\newcommand\semester{2020}
\newcommand\hwnumber{11}                 % <-- ASSIGNMENT #
\newcommand\NetIDa{Nathan, Jacques}           % <-- YOUR NAME
\newcommand\NetIDb{NOMA : 10331500}           % <-- STUDENT ID #
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% }
...
\lhead{\NetIDa}
%\lhead{\NetIDa\\\NetIDb}
\chead{\textbf{\Large Partie \\ commandable/observable}}
