...
\begin{itemize}
    ...
    \item Let $x$ be a gaussian vector with mean $m_x$ and covariance $C_{xx}$. Let vectors $a$ and $b$ be given. Give an unbiased estimator of $\theta := a^Tx$ based on $z := b^Tx$, with a \sout{variance} \textbf{MSE}\footnote{Le professeur a changé pendant l'examen} as small as possible. Give your development in detail.
\end{itemize}
