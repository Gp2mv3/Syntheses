...
\section{}
Let Z be an observed random vector in $\mathbb{R}^n$ and $g:\mathbb{R}^n\to \mathbb{R}$ an estimation rule for a stochastic estimand $\Theta$ (Bayesian estimation). Suppose that $\mathbb{E}[g(Z)]=\mathbb{E}[\Theta]$ and that we have a function $h:\mathbb{R}^n \to \mathbb{R}$ such that $\mathbb{E}[h(Z)]=m_{h(Z)}$ is known. Consider the new estimation rule \begin{equation}
