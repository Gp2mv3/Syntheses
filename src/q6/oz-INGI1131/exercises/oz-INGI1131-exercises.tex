...
\begin{solution}
  %3a
  \lstinputlisting[linerange={2-7}]{APE5/q3.oz}
  \begin{itemize}
  	\item 2 choices are possible. We can manually wait :
	
	\lstinputlisting[linerange={8-9}]{APE5/q3.oz}
	
	\item Or we can do it using a procedure :
	
	\lstinputlisting[linerange={17-23}]{APE5/q3.oz}
  \end{itemize}
  %3b
  \lstinputlisting[linerange={25-32}]{APE5/q3.oz}
  \begin{itemize}
  	\item We can make the same choices :
	
	\lstinputlisting[linerange={33-34}]{APE5/q3.oz}
	
	\item \lstinputlisting[linerange={43-50}]{APE5/q3.oz}
  \end{itemize}
  %3c
  \lstinputlisting[firstline=52]{APE5/q3.oz}
