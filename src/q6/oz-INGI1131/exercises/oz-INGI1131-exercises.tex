...
{Tanguy De Bels\and Victor Feyens\and Beno\^it Legat\and Fran\c{c}ois Robinet\and Florian Thuin \and Julien Launois \and Gauthier de Moffarts}
{Peter Van Roy}
...
\begin{itemize}
\item Question 3a
  \lstinputlisting[linerange={3-7}]{APE5/q3.oz}
    From here, 2 choices are possible. We can manually wait:
    \lstinputlisting[linerange={8-9}, firstnumber=6]{APE5/q3.oz}
    Or we can do it using a procedure:
    \lstinputlisting[linerange={17-23}, firstnumber=6]{APE5/q3.oz}

\item Question 3b
  \lstinputlisting[linerange={26-32}]{APE5/q3.oz}
    We can make the same choices:
    \lstinputlisting[linerange={33-34}, firstnumber=8]{APE5/q3.oz}
    or
    \lstinputlisting[linerange={43-50}, firstnumber=8]{APE5/q3.oz}

\item Question 3c
  \lstinputlisting[firstline=53]{APE5/q3.oz}

  To get more information about MapRecord see~\ref{MapRecordConcurrent}.
\end{itemize}
\end{solution}
...
\selectlanguage{english} % Pour avoir le texte en anglais, vu que le doc est en fr
\missingsolutiontext{the sub-question with the state diagram}

In addition to the state diagram, the code modelling the dishwasher is asked during the lab session.
\lstinputlisting{APE10/q1.oz}
\end{solution}
\subsection{Building redefining}
\nosolution
\subsection{Controller}
\begin{solution}
  \lstinputlisting{APE10/q3.oz}
\end{solution}
