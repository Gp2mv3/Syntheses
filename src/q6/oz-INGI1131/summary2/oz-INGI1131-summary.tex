...
<s> ::= \lstinline|skip|
\alt <s>$_1$ <s>$_2$
\alt \lstinline|local| <x> \lstinline|in| <s> \lstinline|end|
\alt <x>$_1$ = <x>$_2$
\alt <x> = <v>
\alt if <x> \lstinline|then| <s>$_{1}$ \lstinline|else| <s>$_{2}$ \lstinline|end|
\alt \lstinline|case| <x> \lstinline|of| <pattern> \lstinline|then| <s>$_{1}$ \lstinline|else| <s>$_{2}$ \lstinline|end|
...
<procedure> ::= \lstinline|proc| \{\$ <x>$_{1}\ \cdots$ <x>$_{n}$\} <s>  \lstinline|end|
\end{indentgrammar}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.6\textwidth]{img/latch}
