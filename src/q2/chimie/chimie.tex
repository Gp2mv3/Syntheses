...
\usepackage{chemfig}
\usepackage{numprint}
\usepackage[pdfauthor={Benoît Legat, Lucas Nyssens, Laurent Opsomer},
pdftitle={Synthèse de Chimie Q2 - LFSAB1301},
pdfsubject={Chimie}]{hyperref}
\usepackage{appendix}
...
\[ \Delta H = {E_l}_\mathrm{réactifs} - {E_l}_\mathrm{produits} \]
...
Réaction de neutralisation \textbf{complète} = équivalence: même nombre de moles \ce{H+} et \ce{OH-} (exercices \cite[p.~4]{godard}).
...
Une \textbf{base} est une espèce, ion ou molécule, susceptible de fixer un proton \ce{H+} (= accepteur de proton) sur un doublet d'électrons non-liants: $\ce{B + H+ <=> BH+}$ (exercices \cite[p.~6]{godard}).
...
\begin{table}[h!]
	\begin{center}
		\begin{tabular}{|p{0.1\textwidth}|p{0.35\textwidth}|p{0.35\textwidth}|p{0.2\textwidth}|}
			...
			\hline
			$E_A$ & \'Electroaffinité d'un atome & Absorbée pour capter un $e^-$ & \ref{sec:electro} p.~\pageref{sec:electro}\\
