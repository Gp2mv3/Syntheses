...
On peut généraliser le cas pour tous les atomes et les ions possédants exactement $1$ électron, qui sont dits \emph{monoélectroniques}. 
On dira alors que les sous-couches associées au même nombre quantique principal sont dégénérées, c'est-à-dire que celles-ci ont la même énergie.
  
\section{Atomes polyélectroniques}
\begin{itemize}
  \item[$\bullet$] \'Ecrantage: Chaque électron est blindé contre l’attraction complète du noyau par les couches inférieures d'électrons (répulsions interélectroniques) 
  ...
  \item[$\bullet$] Effet de pénétration des $e^-$: un $e^-$ $\sorb$ de n'importe quelle couche peut se trouver près du noyau 
