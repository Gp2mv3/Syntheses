...
\`A $0\celsius$ sous \numprint[kPa]{101.3} (conditions normales) \textbf{une mole} de gaz occupe un volume de \textbf{22.4 l}.
...
Soit une équation du type: \ce{aA(g) + bB(g) <=> cC(g) + dD(g)}
...
Constance d'équilibre de cette réaction: $$K_c=\frac{[\ce{A-}][\ce{H3O+}]}{[\ce{HA}][\ce{H2O}]}$$

\paragraph{Constante d'acidité}
$$K_a=K_c[\ce{H2O}]=\frac{[\ce{A-}][\ce{H3O+}]}{[\ce{HA}]}$$ et $$pK_a=-\log{K_a}$$
