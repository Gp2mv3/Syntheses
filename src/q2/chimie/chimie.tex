...
{Benoît Legat, Lucas Nyssens et Laurent Opsomer}
{Benoît Legat \and Lucas Nyssens \and Laurent Opsomer}
...
correspon à l'énergie nécessaire pour en obtenir des molécules plus complexes connues,
...
c'est-à-dire son aptitude à se séparer de la molécule \ce{HA} sous forme de \ce{H+},
...
\begin{itemize}
  \item[$\bullet$] Plus la liaison est \textbf{polaire},
    ...
    La polarité est liée à \textbf{l'électronégativité} de A mais aussi à la taille de l'ion \ce{A-},
...
\begin{itemize}
  \item[$\bullet$] Plus le nombre d'atomes \textbf{\ce{O}} liés à l'atome central est grand,
    plus l'acide est \textbf{fort};
