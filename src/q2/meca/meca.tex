...
\usepackage[pdfauthor={Benoît Legat}, pdftitle={Synthèse LFSAB1202},
...
\[ J(q, t) \dqp = 0 \]
Ensuite, on exprime $\Delta \xgd^i$ et $\Delta \omegaf^i$ en fonction de $\dqp$ ainsi
\begin{eqnarray*}
	\Delta \xgd^i &=& \xgd^i(\qp + \dqp, q) - \xgd^i(\qp, q)\\
	\Delta \omegaf^i &=& \omegaf^i(\qp + \dqp, q) - \omegaf^i(\qp, q)
\end{eqnarray*}
\paragraph{Exemple}
Si $\xgd = 2\qp_1 \ui_1 + \omega q_1 \ui_2$,
\begin{eqnarray*}
	\Delta \xgd^i &=& 2(\qp_1 + \dqp_1) \ui_1 + \omega q_1 \ui_2 - (2\qp_1 \ui_1 + \omega q_1 \ui_2)\\
	&=& 2 \dqp_1 \ui_1
\end{eqnarray*}
