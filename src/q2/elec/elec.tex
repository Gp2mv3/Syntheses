...
{Nicolas Cognaux, Beno\^it Legat et Lucas Nyssens}
{Nicolas Cognaux \and Beno\^it Legat \and Lucas Nyssens}
...
\section{Flux}
Le flux électrique d'un champ magnétique $E$
...
Si ce courant rencontre un champ magnétique $\B$ et un champ magnétique $\E$,
...
maintenant connecté à la borne - et vice versa.
...
Le champs à une distance $x$ sur l'axe d'une spire de rayon
...
%% NC: Alors ici la démo j'ai pas réellement compris son truc donc je vais
% pas me risquer à expliquer. Il y a un angle phi qui aparait sans raison...
...
\begin{itemize}
  ...
  \item Les bobines de Helmholtz sont des bobines espacées
    ...
    comme vous pouvez le constatez par la \figuref{deqr}.
\end{itemize}
\begin{figure}
  \begin{center}
