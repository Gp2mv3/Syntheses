...
\end{eqnarray*}
où $\ine^G \eqdef -\int_C \tilde{\fv{r}}\cdot\tilde{\fv{r}} \dif m$, on l'appelle le tenseur d'inertie.
Il respecte les propriétés suivantes

\begin{itemize}
    \item Ses composantes (exprimées en \si{\kilo\gram\meter\squared}) sont constantes lorsqu'il
