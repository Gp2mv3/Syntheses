...
\begin{itemize}
    ...
    Les éléments de la diagonale de $\wtr{K}{I}{G}$ sont appelés les moments principaux d'intertie.
...
On peut alors réecrire le principe des puissances potentielles de la manière suivante :
...
Il produit deux forces, une horizontale et une verticale. % C'est bien de l'appui qu'on parle?

\subsection{Appui simple}
Symbolisé par un cercle touchant le corps.
Il produit une force, perpendiculaire à la tangente du cercle au point de contact.
