...
\begin{itemize}
  \item Ses composantes (exprimées en $[\si{\kilogram\meter\squared}]$) sont constantes lorsqu'il
...
la valeur d'un effort interne en fonction de la position $x$ de la ``coupure''.
 P  ar convention ces diagrammes
