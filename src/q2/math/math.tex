...
\begin{itemize}
	...
	\item Si $a_1, \dots, a_n \in \R$,
		...
		\[ r_1, \dots, r_p \in \R, \qquad s_1, \dots, s_t \in \C \backslash \R, \qquad
		\overline{s_1}, \dots, \overline{s_t} \in \C \backslash \R \]
		avec multiplicité respective $m_1, \dots, m_p$, $n_1, \dots, n_t$, $n_1, \dots, n_t$.
		Le fait de dire que si $s_j$ est racine, alors $\overline{s_j}$ l'est aussi vient du fait que $a_1, \dots, a_n \in \R$.
