...
\begin{table}[!ht]
	...
	\hline
	Polaires & $$\displaystyle (r\cos \theta, r\sin \theta)$$ & $$\displaystyle dA = rdrd\theta$$ \\
	\hline
	Cylindriques & $$\displaystyle (r\cos \theta, r\sin \theta, h)$$ & $$\displaystyle dV = rdrd\theta dh$$ \\
	\hline
	Sphériques & $$\displaystyle (\rho \sin \phi \cos \theta, \rho \sin \phi \sin \theta, \rho \cos \theta)$$
	& $$\displaystyle dV = \rho^2 \sin \theta d\rho d\phi d\theta$$
	\end{tabular}
\end{table}
