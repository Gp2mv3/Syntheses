...
{Stéphane Mercier} [
    ...
    ``IIe siècle ap. J.-C.'' s'écrira ``+2s'',
    ``Ier-IIe siècles ap. J.-C.'' s'écrira ``+1s,+2s'' et
    ``IIIe millénaire av. J.-C.'' s'écrira ``-3m''.
]

\part{Babylone, l'Égypte et la Bible}
Notre civilisation occidentale est marquée par l'empreinte de la \textbf{Bible} et donc d'une sagesse d'origine \textbf{proche-orientale}, plus particulièrement du \textbf{Croissant fertile}.
La sagesse biblique se résumé à 5 livres ``sapientiaux'' ; ils contiennent une réflexion de sagesse sur la condition humaine et sur les rapports entre l'homme, le cosmos et Dieu. 3 livres proviennent de la Bible hébraïque :
\begin{itemize}
    \item \textit{Job} (dialogue tragique),
    \item \textit{Qohélet} ou l'\textit{Ecclésiaste} (essai philosophique),
    \item les \textit{Proverbes} (receuil d'instructions de sagesse).
\end{itemize}
2 livres dits ``deutérocanoniques'' (appartenant au 2e canon) figurent dans la Bible grecque (la Septante) :
\begin{itemize}
    \item le \textit{Siracide} ou \textit{Ecclésiastique},
    \item la \textit{Sagesse} dite \textit{de Salomon}.
\end{itemize}
Ces livres forment un tout car tous proposent des \textbf{chemins de sagesse} nourris de l'\textbf{expérience humaine}, de la \textbf{transmission d'un savoir} fondé sur la \textbf{connaissance du monde}, \textbf{l'analyse des événements} et le \textbf{discernement d'un sens} dans le cours du réel. \\
Évoquer les sagesses bibliques de l'Ancien Testament implique d'appréhender les \textbf{contextes culturels de ces écrits}.  C'est l'objectif des prochaines sections.

\section{Sagesses mésopotamiennes}

L'écriture a probablement été inventée dans le pays de \textbf{Sumer} dans la seconde moitié du -4s. 
Elle répond à des besoins économiques et administratifs en soulageant la mémoire humaine. 
L'écriture sumérienne est en \textbf{cunéiforme} (forme de clou). 
Au -2s, l'\textbf{akkadien} supplante le sumérien et devient la langue de référence dans le Proche-Orient.
C'est dans cette langue que sont écrits les récits véhiculant les permières réflexions de sagesse.
La littérature akkadienne est soit une littérature \textbf{épique}, soit liée aux pratiques du culte.
Le sage est à cette époque un expert de la religion.
À la fin du -2s apparait l'\textbf{araméen alphabétique} qui fait concurrence au cunéiforme, sur papyrus ou peaux au lieu de tablettes d'argile.

\paragraph{Les \textit{Instructions de Shuruppak} (sumérien, -3s)} Ce texte sumérien prête à Shuruppak, le roi de la cité du même nom, une série de conseils hétéroclites dispensés à son fils surnommé par les Sumériens \textbf{Ziusudra} ``Vie aux longs jours''. Ce dernier est considéré comme le Noé mésopotamien. Shuruppak exhorte ainsi à faire confiance à ses proches mais à se méfier des esclaves, à fréquenter les bons en évitant les méchants, etc.

\paragraph{L'\textit{Épopée de Gilgamesh} (akkadien, -2s)}
Ce texte akkadien est la première épopée mondiale, dans laquelle le héros \textbf{interroge les limites de la condition humaine} et se confronte aux grandes \textbf{questions existentielles}. Gilgamesh (``l'ancêtre est un héros / un jeune homme'') était un roi de la cité d'Uruk, mais son histoire est méconnue. Dans le texte, il apparait comme un tyran qui opprime son peuple, et auquel les \textbf{dieux} suscitent un rival, \textbf{Enkidu}, ``créature du Dieu Enki''. Les deux hommes s'affrontent, reconnaissent leur valeur respective, et deviennent amis ; ils se lancent alors dans des aventures propres à rendre leur nom immortel, mais \textbf{leur orgueil conduit Enkidu à sa perte}. Sa mort, pleurée par son ami, décide Gilgamesh à se mettre en \textbf{quête de l'immortalité}. Il partit à la recherche d'un homme qui connaissait le secret de l'immortalité, Uta-napishtim (``Il a trouvé la vie'', équivalent akkadien de Ziusudra). Ce dernier lui apprit que l'immortalité ne lui a été octroyée qu'à la suite de circonstances exceptionnelles pas prêtes de se reproduire. L'échec de cette quête le contraint à accepter sa condition mortelle.

\paragraph{L'\textit{Épopée d'Atrahasis} (akkadien, -2s)}
Au commencement, les hommes n'existaient pas et les dieux vivaient dans le monde. Les dieux supérieurs bénéficiaient du travail des dieux inférieurs. Ces derniers en avaient ras-le-bol et on convint de façonner pour servir tout les dieux des serviteurs dévoués : les hommes.
Leur multiplication les rendit nombreux et bruyants (vraisemblablement une métaphore de l'orgueil) et le dieu Enlil n'arrivait plus à dormir. Il décida donc de détruire le genre humain par une épidémie. Enki, un autre dieu, qui comprit que l'action d'Enlil menaçait le confort des dieux, se rendit auprès de son protégé Atrahasis ``le Supersage'' (c'est en fait Ziusudra, encore lui !). Il put sauver les hommes en implorant le secours d'une autre divinité sous les directives d'Enki. \\
Enlil était bien sûr véner et essaya à nouveau de détruire le genre humain par la sécheresse et la famine, mais \sout{Superman} Supersage a su déjouer ses plans à l'aide d'Enki. Enlil fit alors jurer les dieux qu'ils n'avertiraient plus les hommes et envoya une tempête qui engloutirait l'humanité (le Déluge). Mais Enki n'est pas con, et s'adresse aux murs de son palais tout en veillant à ce qu'Atrahasis puisse l'entendre. Ce dernier fit donc construire une arche où il installa ces proches et plein d'animaux. Les dieux comprirent que le déluge avait failli leur priver à jamais de leurs serviteurs, et résolvèrent les problèmes de surpopulation en réduisant l'espérance de vie des hommes. Comme récompense, le Supersage reçut le don de l'immortalité.
