...
\paragraph{\textit{L'histoire et la sagesse d'Ahiqar}}
    Même leçon qu'au précédent :
    \textquote{Le mal n'a qu'un temps, et le juste, s'il est vraiment juste
    finira par être reconnu comme tel et secouru par une divinité
...
de \textit{Job}). Le mauvais finira toujours par payer alors que le juste
...
autorise une forme de révolte. Au final, le juste est récompensé et le méchant
est puni : rejette l'idée simpliste d'un Dieu vengeur.
A été écrit durant la période de domination perse, ce qui explique cette vision
du mal.
...
Il retourne à la théodicée traditionnelle et affirme que le mal est une
...
Dualisme dans l'homme entre l'\^ame et du corps :
le corps est une sorte de cage qui emprisonne l'\^ame,
il a donc une connotation négative.
L'\^ame est prisonnière du corps à cause d'une faute de l'homme,
malgré qu'il ne sache pas toujours en quoi elle consiste,
elle est l'héritage d'une culpabilité que les hommes doivent assumer en
entrant dans ce monde ($\approx$ \textit{karma} des Indiens ou péché originel des
chrétiens).
Cette faute explique pourquoi notre vie est penchée sous le signe de la
souffrance et de l'insatisfaction.

Ce dualisme se mélange aussi avec la pensée juive de la Genèse :
à la base Dieu créa l'homme, \textquote{et Dieu vit que cela était bon},
mais l'héritage du péché originel s'est imprimé dans ce corps qui devient alors chair, en opposition avec l'esprit.  Pourtant les grecs ont une fascination obsédante pour la beauté physique : paradoxe amour-haine qui les tiraillent entre deux aspirations inconciliables.
...
\subsection{La vertu est le mal}
...
sans pour autant agir en conséquence par le fait que la faiblesse de volonté
...
la piété filiale et la vertu
(capable de transformer une mauvaise situation en bien).
La vertu se caractérise par le sens du rite (héritage des anciens, tradition,
super important dans la vie quotidienne) et l'humanité.
...
\begin{itemize}
    \item celle de \textbf{Linji} consiste à se faire une commotion mentale
        ...
        et ce prompt effet de surprise sera peut-être l'occasion
