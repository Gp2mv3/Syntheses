...
Pour trouver le bonheur, il faut donc être vertueux, c'est à dire, à être excellement l'être humain qu'il est.
...
En effet, jusqu'au $+2s$, la plupart des philosophe sont matérialistes.
...
D'où vient alors l'opposition entre corps-matière et âme immatérielle ? De \textbf{Platon}, entre
...
de totalement autre qu'elle, a été défendue par \textbf{Aristote}, disciple de Platon, qui, bien qu'il
...
la plupart d'entre eux pendant plusieurs siècles, cette âme, bien que spécifiquement distincte du corps avec lequel elle a partie liée durant cette vie, n'en est pas moins \textit{matérielle}.
Notons encore que le nom latin de l'âme est \textit{animus} (ou \textit{anima}, mais ceci nous entraînerait trop loin, retenons seulement que les deux termes permettent une série de nuances),
c'est-à-dire ``souffle'' vital, exactement : principe d'animation qui fait de l'être qui en est
doté un être \textit{animé} ou, cela revient au même, \textit{vivant}.

Une fois encore, qu'il n'y ait pas de malentendu : un être vivant, précisément parce qu'il
est vivant, possède une âme. L'arbre, le chat et l'être humain ont \textit{tous} une âme. Car
...
permet de le définir comme \textit{animal (animé) rationnel}.
...
Fondée à la fin du IVe siècle av. J.-C. par \textbf{Zénon de Citium}, cette école philosophique
...
impériale sont trois personnages remarquables : \textbf{Sénèque}, précepteur impérial et sénateur
romain (Ier siècle ap. J.-C.), \textbf{Épictète}, ancien esclave et enseignant affranchi (Ier-IIe siècles ap. J.-C.), et \textbf{Marc Aurèle}, qui présida personnellement aux destinées du monde
...
étymologiquement, les passions, \textit{pathê} en grec, sont des choses que l'on subit, dont on
n'est pas le maître, sur lesquelles la raison n'exerce pas ou pas assez son contrôle : un
accès de panique, un désordre amoureux, etc. Ce sont très exactement des maladies mentales, selon la traduction latine que propose Cicéron, \textit{perturbationes animi} : quand la
...
\textit{éradiquer}.
Car il ne saurait être question d'atténuer simplement les passions, pour les
...
gardera de traduire littéralement : l'\textit{apatheia} des philosophes du Portique n'est pas
...
Comprenons toutefois que cela ne signifie pas que l'homme idéal est un raisonneur enfermé dans sa tour
...
que cette affirmation n'ôte pas la \textit{responsabilité} du mal à celui qui le commet :
l'ignorance peut être coupable. L'autre, c'est que les anciens philosophes et nous ne
concevons pas la \textit{volonté} de manière identique. En effet, nous sommes habitués à penser
...
que la volonté suit \textit{nécessairement} l'intelligence.
...
devoir faire et ce qu'elle veut faire, c'est qu'on \textit{prétend} savoir, mais qu'en fait, on ne sait
pas vraiment, au sens où l'on n'a pas vraiment \textit{intériorisé} ce savoir, on ne l'a pas vraiment fait sien. Ce savoir que l'on dit avoir est donc superficiel, une sorte d'épiphénomène
...
ressources pour se libérer de tout esclavage \textit{véritable} en rétablissant les droits de la raison
...
\section{Résumé}
On reconnait un philosophe pas ses actes et non seulement par sa parole.
Être vertueux, c'est mener une vie en accord avec sa nature propre, c'est à dire notre raison.
On doit se débarrasser des passions folles qui nous font perdre de la liberté à notre raison
et se concentrer sur des passions raisonnables selon les stoïciens.
